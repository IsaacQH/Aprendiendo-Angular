...
@Component({                   //Decorador component
  ...
  imports: [CommonModule, RouterOutlet, VideojuegoComponent, ZapatillasComponent, CursosComponent, homeComponent, FormsModule, RouterModule, ExternoComponent, HttpClientModule],    
